        ...
        <div class="col-sm-9 page-content">
          ...
          <div class="inner-box">
            <div class="welcome-msg">
				<h3 class="page-sub-header2 clearfix no-padding">Category <div class="pull-right"><a href="{{ route('admin-category-edit', 0) }}" class="btn btn-primary">Add Category</a></div></h3>
            ...
            <div>
              <table class="table table-striped table-bordered add-manage-table table demo footable-loaded footable">
                ...
                <tr>
                  ...
                  <td>
                    <p><a class="btn btn-info btn-xs" href="{{ route('admin-category-edit', $row->id) }}"> <i class="fa fa-recycle"></i> Edit </a> </p>
                    <p><a class="btn btn-danger btn-xs" href="{{ route('admin-category-delete', $row->id) }}"> <i class=" fa fa-trash"></i> Delete </a></p>
                    
                  </td>
                </tr>
                @endforeach
				<tr>
					<td colspan="4">{{ $category->links() }}</td>
				</tr>
