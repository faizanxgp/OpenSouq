							...
							<table class="table table-hover">
								...
								@foreach ($emails as $item)
									<tr>
										...
										<td>
											<!-- //TODO -->
											<p><a class="btn btn-info btn-xs" href="{{ route('admin.updemail', $item->id) }}"> <i class="fa fa-recycle"></i> Edit </a> <a class="btn btn-danger btn-xs" href="{{ route('admin.updemail', $item->id) }}"> <i
															class=" fa fa-trash"></i> Delete </a></p>
								...
								<tr>
									<td colspan="3">
										<a class="btn btn-md btn-info" href="">Add New</a>
									</td>
