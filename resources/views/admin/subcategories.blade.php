				...
				<div class="col-sm-9 page-content">
					...
					<div class="inner-box">
						<div class="welcome-msg">
							...
							<h3 class="page-sub-header2 clearfix no-padding">Sub Category <div class="pull-right"><a href="{{ route('admin-subcategory-edit', 0) }}" class="btn btn-primary">Add SubCategory</a></div></h3>
							...
							<table class="table table-striped table-bordered add-manage-table table demo footable-loaded footable">
								...
								@foreach($subcategory as $row)
									<tr>
										...
										<td>
											<p><a class="btn btn-info btn-xs" href="{{ route('admin-subcategory-edit', $row->id) }}"> <i class="fa fa-recycle"></i> Edit </a></p>
											<p><a class="btn btn-danger btn-xs" href="{{ route('admin-subcategory-edit', $row->id) }}"> <i class=" fa fa-trash"></i> Delete </a></p>

										</td>
									</tr>
								@endforeach
								<tr>
									<td colspan="5">{{ $subcategory->links() }}</td>
								</tr>
								</tbody>
							</table>
						</div>
