            ...
            <div>
              <table class="table table-striped table-bordered add-manage-table table demo footable-loaded footable">
                ...
                <tr>
                  ...
                  <td>{{ $row->email }}</td>
                  <td>{{ $row->phone }}</td>
                  <td>{{ $user_type[$row->user_type] or '' }}</td>
                  <td>{{ $user_status[$row->status] or '' }}</td>
                  <td>
                    <p><a class="btn btn-info btn-xs" href="{{ route('admin-user-edit', $row->id) }}"> <i class="fa fa-recycle"></i> Edit </a> </p>
                    <p><a class="btn btn-danger btn-xs" href="{{ route('admin-user-delete', $row->id) }}"> <i class=" fa fa-trash"></i> BAN </a></p>
