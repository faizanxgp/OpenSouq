					...
					<div class="inner-box category-content">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								{{ Form::open(['method' => 'post', 'route' => 'post-ads', 'files' => true, 'class' => 'form-horizontal']) }}
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											{{--{{ Form::select('category', $category, null, ['class' => 'form-control category', 'placeholder' => 'Select...', 'id' => 'category']) }}--}}
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<label for="radios-0" class="radio-inline"> <input type="radio" checked="checked" value="1" id="radios-0" name="ad_type"> Private </label> <label for="radios-1" class="radio-inline"> <input type="radio" value="2"
														id="radios-1" name="ad_type"> Business </label>
										</div>
									</div>
									...
									<div class="form-group {{ $errors->has('ad_title') ? ' has-error' : '' }}">
										...
										<div class="col-md-8">
											<input type="text" required="" class="form-control input-md" placeholder="Ad title" name="ad_title" id="Adtitle" value="{{ old('ad_title') }}"> <span class="help-block">A great title needs at least 60 characters. </span>
                            ...
                            <strong>{{ $errors->first('ad_title') }}</strong>
									...
									<div class="form-group {{ $errors->has('ad_description') ? ' has-error' : '' }}">
										...
										<div class="col-md-8">
											<textarea name="ad_description" id="textarea" class="form-control" placeholder="Describe what makes your ad unique" rows="10">{{ old('ad_description') }}</textarea>
                            ...
                            <strong>{{ $errors->first('ad_description') }}</strong>
									...
									<div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
										...
										<div class="col-md-4">
											<div class="input-group"><span class="input-group-addon"> JD </span> <input type="text" required="" placeholder="Amount" class="form-control" name="price" id="Price" value="{{ old('price') }}">
												@if ($errors->has('price'))
													<span class="help-block">
                            <strong>{{ $errors->first('price') }}</strong>
										...
										<div class="col-md-4">
											<div class="checkbox">
												<label> <input type="checkbox" name="negotiable" value="1"> Negotiable </label>
											</div>
										</div>
									</div>
									...
									<div class="form-group" id="data1" style="display: none;">
										...
										<div class="col-md-8" id="data1elem">
											<input type="text" class="form-control input-md" placeholder="" name="data1"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data2" style="display: none;">
										...
										<div class="col-md-8" id="data2elem">
											<input type="text" class="form-control input-md" placeholder="" name="data2"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data3" style="display: none;">
										...
										<div class="col-md-8" id="data3elem">
											<input type="text" class="form-control input-md" placeholder="" name="data3"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data4" style="display: none;">
										...
										<div class="col-md-8" id="data4elem">
											<input type="text" class="form-control input-md" placeholder="" name="data4"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data5" style="display: none;">
										...
										<div class="col-md-8" id="data5elem">
											<input type="text" class="form-control input-md" placeholder="" name="data5"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data6" style="display: none;">
										...
										<div class="col-md-8" id="data6elem">
											<input type="text" class="form-control input-md" placeholder="" name="data6"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data7" style="display: none;">
										...
										<div class="col-md-8" id="data7elem">
											<input type="text" class="form-control input-md" placeholder="" name="data7"> <span class="help-block"></span>
										</div>
									</div>
									<div class="form-group" id="data8" style="display: none;">
										...
										<div class="col-md-8" id="data8elem">
											<input type="text" class="form-control input-md" placeholder="" name="data8"> <span class="help-block"></span>
										</div>
									</div>
									<!-- photo -->
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="mb10">
												<span class="file-input file-input-new"><input class="form-control" name="photos[]" id="filer_input" type="file" multiple="1"></span>

											</div>
											<p class="help-block">Add up to 24 photos of JPG/JPEG type. Use a real image of your product, not catalogs.</p>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control input-md" placeholder="" name="youtube" id="youtube" value="{{ old('youtube') }}"> <span class="help-block">URL of Youtube video e.g. http://youtube.com/watch?v=<strong>yourid</strong> </span>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group {{ $errors->has('posted_by') ? ' has-error' : '' }}">
										...
										<div class="col-md-8">
											<input type="text" required="" class="form-control input-md"
													...
													name="posted_by" id="textinput-name" value="{{ old('posted_by' , $user->name) }}">
                            ...
                            <strong>{{ $errors->first('posted_by') }}</strong>
									...
									<div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
										...
										<div class="col-md-8">
											<input type="text" required="" class="form-control input-md"
													placeholder="00962xxxxxxxx"
													name="phone" id="textinput-phone" value="{{ old('phone', $user->phone) }}"><p class="help-block">e.g. 00962xxxxxxxx (13-14 digits)</p>
											@if ($errors->has('phone'))
												<span class="help-block">
                            <strong>{{ $errors->first('phone') }}</strong>
								...
								<!-- Select Basic -->
									<div class="form-group {{ $errors->has('seller_area') ? ' has-error' : '' }}">
										...
										<div class="col-md-8">
											{{ Form::select('seller_area', $city, null, ['class' => 'form-control', 'placeholder' => 'Select...', 'id' => 'location']) }}
                            ...
                            <strong>{{ $errors->first('seller_area') }}</strong>
								...
								<!-- Button  -->
									<div class="form-group">
										...
										<div class="col-md-8"><input class="btn btn-success btn-lg" id="button1id"
													type="submit"
													name="submit" value="Post Ad"/></div>
										{{ csrf_field() }}
									</div>
								</fieldset>
								</form>
...
@section('js')
	...
	<script type="text/javascript">
		jQuery(document).ready(function () {
			...
			jQuery("#combo-sub-cat").on('change', function () {
				...
				for (var i = 0, json_len = arr.length; i < json_len; i += 1) {
					...
					if (j.id == sel) {
						if (j.data1 != "") {
							...
							filler(j.details1, 'none', 'data1', 'data1elem');
						}
						if (j.data2 != "") {
							jQuery('#data2').show();
							jQuery('label.data2').text(j.data2);
							filler(j.details2, 'none', 'data2', 'data2elem');
						}
						if (j.data3 != "") {
							jQuery('#data3').show();
							jQuery('label.data3').text(j.data3);
							filler(j.details3, 'none', 'data3', 'data3elem');
						}
						if (j.data4 != "") {
							jQuery('#data4').show();
							jQuery('label.data4').text(j.data4);
							filler(j.details4, 'none', 'data4', 'data4elem');
						}
						if (j.data5 != "") {
							jQuery('#data5').show();
							jQuery('label.data5').text(j.data5);
							filler(j.details5, 'none', 'data5', 'data5elem');
						}
						if (j.data6 != "") {
							jQuery('#data6').show();
							jQuery('label.data6').text(j.data6);
							filler(j.details6, 'none', 'data6', 'data6elem');
						}
						if (j.data7 != "") {
							jQuery('#data7').show();
							jQuery('label.data7').text(j.data7);
							filler(j.details7, 'none', 'data7', 'data7elem');
						}
						if (j.data8 != "") {
							jQuery('#data8').show();
							jQuery('label.data8').text(j.data8);
							filler(j.details8, 'none', 'data8', 'data8elem');
						}
						break;
					}
				}
