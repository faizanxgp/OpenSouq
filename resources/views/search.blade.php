            ...
            <div class="inner-box">
              <div class="categories-list  list-filter">
                ...
                <ul class=" list-unstyled">
                  <li><a href="#"><span class="title">Electronics</span><span
                          class="count">&nbsp;8626</span></a>
                  </li>
                  <li><a href="#"><span class="title">Automobiles </span><span
                          class="count">&nbsp;123</span></a></li>
                  <li><a href="#"><span class="title">Property </span><span class="count">&nbsp;742</span></a>
                  </li>
                  <li><a href="#"><span class="title">Services </span><span class="count">&nbsp;8525</span></a>
                  </li>
                  <li><a href="#"><span class="title">For Sale </span><span class="count">&nbsp;357</span></a>
                  </li>
                  <li><a href="#"><span class="title">Learning </span><span class="count">&nbsp;3576</span></a>
                  </li>
                  <li><a href="#"><span class="title">Jobs </span><span class="count">&nbsp;453</span></a>
                  </li>
                  <li><a href="#"><span class="title">Cars &amp; Vehicles</span><span
                          class="count">&nbsp;801</span></a>
                  </li>
                  <li><a href="#"><span class="title">Other</span><span class="count">&nbsp;9803</span></a>
                  </li>
                </ul>
              </div>
              <!--/.categories-list-->
              ...
              <div class="locations-list  list-filter">
                ...
                <ul class="browse-list list-unstyled long-list">
                  ...
                  <li class="maxlist-hidden" style="display: none;"><a href="#"> San
                      Diego </a></li>
                  <li class="maxlist-hidden" style="display: none;"><a href="#">
                      Boston </a></li>
                  <li class="maxlist-hidden" style="display: none;"><a href="#">
                      Houston </a></li>
                  <li class="maxlist-hidden" style="display: none;"><a href="#">Salt Lake
                      City </a></li>
                  <li class="maxlist-hidden" style="display: none;"><a href="#"> Other
                      Locations </a></li>
                </ul>
              ...
              <div class="locations-list  list-filter">
                ...
                <ul class="browse-list list-unstyled long-list">
                  ...
                  <li><a href="#">Business <span class="count">28,705</span></a></li>
                  <li><a href="#">Personal <span class="count">18,705</span></a></li>
                </ul>
              </div>
              <!--/.list-filter-->
              <div class="locations-list  list-filter">
        ...
        <div class="col-sm-9 page-content col-thin-left">
            ...
            <div class="tab-filter">
              <div class="selecter select-short-by closed" tabindex="0"><select tabindex="-1" class="selectpicker selecter-element" data-style="btn-select" data-width="auto">
                ...
                <div class="selecter-options scroller">
                  ...
                  <div class="scroller-content"><span class="selecter-item selected" data-value="Short by">Short by</span><span class="selecter-item"
          ...
          <div class="listing-filter">
            ...
            <div class="pull-right col-xs-6 text-right listing-view-action"><span class="list-view active"><i
                    class="  icon-th"></i></span> <span class="compact-view"><i class=" icon-th-list  "></i></span>
              ...
              <div class="item-list">
                ...
                <div class="col-sm-2 no-padding photobox">
                  <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                        href="#"><img class="thumbnail no-margin" src="images/item/tp/Image00015.jpg"
                                                     alt="img"></a></div>
                </div>
                <!--/.photobox-->
