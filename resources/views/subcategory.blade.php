			...
			<div class="row">
						...
						<div class="inner-box">
							<div class="categories-list  list-filter">
								...
								{{--<form method="post" action="{{ route('search') }}">--}}
									...
									{{--<label>Search: </label> <input type="text" name="searchstr" class="form-control" value="{{ $searchdata['searchstr'] or '' }}"/>--}}

									{{--<label>Category: </label>--}}
									{{--{{ Form::select('category', $subcateg, $searchdata['categoryid'], ['class' => 'form-control', 'placeholder' => 'All Categories', 'id' => 'category']) }}--}}

									{{--<label>Location: </label>--}}
									{{--{{ Form::select('city', $city, $searchdata['cityid'], ['class' => 'form-control js-locations', 'placeholder' => 'All Locations', 'id' => 'location']) }}--}}

									{{--<label>Price: </label> <input type="text" class="form-control price" maxlength="6" name="price1" value="{{ $searchdata['price1'] }}"/> - <input type="text" class="form-control price" maxlength="6" name="price2"--}}
											{{--value="{{ $searchdata['price2'] }}"/>--}}


									{{--@if ($subCategory)--}}

										{{--@if ($subCategory->data1 != "")--}}

											{{--<label>{{ $subCategory->data1 }}</label>--}}
											{{--@if($subCategory->details1 == "")--}}
												{{--<input type="text" class="form-control" name="data1"/>--}}
											{{--@else--}}
												{{--{{ Form::select('data1', $subCategory->getDetails(1), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
											{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data2 != "")--}}

											{{--<label>{{ $subCategory->data2 }}</label>--}}
											{{--@if($subCategory->details2 == "")--}}
												{{--<input type="text" class="form-control" name="data2"/>--}}
											{{--@else--}}
												{{--{{ Form::select('data2', $subCategory->getDetails(2), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
											{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data3 != "")--}}

											{{--<label>{{ $subCategory->data3 }}</label>--}}
											{{--@if($subCategory->details3 == "")--}}
												{{--<input type="text" class="form-control" name="data3"/>--}}
											{{--@else--}}
												{{--{{ Form::select('data3', $subCategory->getDetails(3), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
											{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data4 != "")--}}

											{{--<label>{{ $subCategory->data4 }}</label>--}}
												{{--@if($subCategory->details4 == "")--}}
													{{--<input type="text" class="form-control" name="data4"/>--}}
												{{--@else--}}
													{{--{{ Form::select('data4', $subCategory->getDetails(4), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
												{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data5 != "")--}}

											{{--<label>{{ $subCategory->data5 }}</label> @if($subCategory->details5 == "")--}}
													{{--<input type="text" class="form-control" name="data5"/>--}}
												{{--@else--}}
													{{--{{ Form::select('data5', $subCategory->getDetails(5), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
												{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data6 != "")--}}

											{{--<label>{{ $subCategory->data6 }}</label> @if($subCategory->details6 == "")--}}
													{{--<input type="text" class="form-control" name="data6"/>--}}
												{{--@else--}}
													{{--{{ Form::select('data6', $subCategory->getDetails(6), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
												{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data7 != "")--}}

											{{--<label>{{ $subCategory->data7 }}</label> @if($subCategory->details7 == "")--}}
													{{--<input type="text" class="form-control" name="data7"/>--}}
												{{--@else--}}
													{{--{{ Form::select('data7', $subCategory->getDetails(7), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
												{{--@endif--}}

										{{--@endif--}}
										{{--@if ($subCategory->data8 != "")--}}

											{{--<label>{{ $subCategory->data8 }}</label> @if($subCategory->details8 == "")--}}
													{{--<input type="text" class="form-control" name="data8"/>--}}
												{{--@else--}}
													{{--{{ Form::select('data8', $subCategory->getDetails(8), null, ['class' => 'form-control', 'placeholder' => '']) }}--}}
												{{--@endif--}}
				...
				<div class="col-sm-9 page-content col-thin-left">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<label>Price: </label><br /> <input type="text" class="form-control price" maxlength="6" name="price1" value="{{ $searchdata['price1'] }}"/> - <input type="text" class="form-control price" maxlength="6" name="price2" value="{{ $searchdata['price2'] }}"/>
						</div>
					...
					{{--<div class="sub-category-filters row">--}}
					{{--<form method="post" action="{{ route('search') }}">--}}
					{{--@if ($subCategory->data1 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data1 }}</label> <input type="text" class="form-control" name="data1"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data2 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data2 }}</label> <input type="text" class="form-control" name="data2"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data3 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data3 }}</label> <input type="text" class="form-control" name="data3"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data4 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data4 }}</label> <input type="text" class="form-control" name="data4"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data5 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data5 }}</label> <input type="text" class="form-control" name="data5"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data6 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data6 }}</label> <input type="text" class="form-control" name="data6"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data7 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data7 }}</label> <input type="text" class="form-control" name="data7"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--@if ($subCategory->data8 != "")--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>{{ $subCategory->data8 }}</label> <input type="text" class="form-control" name="data8"/>--}}
					{{--</div>--}}
					{{--@endif--}}
					{{--<div class="col-sm-4">--}}
					{{--<label>&nbsp;</label><br/> <input type="submit" class="btn btn-primary" name="submit" value="Search"/>--}}
					...
					<div class="tab-box ">
						...
						<ul class="nav nav-tabs add-tabs" role="tablist">
							<li class="active"><a href="#allAds" role="tab" data-toggle="tab">All Ads <span
											class="badge">{{ $listings->total() }}</span></a></li>
						</ul>
					...
					<div class="adds-wrapper">
								...
								<div class="col-sm-7 add-desc-box">
									<div class="add-details">
										...
										<span class="info-row"> @if($row->user->user_type == 1)
											...
											@endif <span class="date"><i class=" icon-clock"> </i> {{ date('M d, Y H:i', strtotime($row->created_at)) }} </span> - <span class="category">{{ $row->subcategory->sub_category }} </span>- <span class="item-location"><i class="fa fa-map-marker"></i> {{ $row->city->city }} </span> </span>
									</div>
								</div>
						...
						{{----}}
						{{--<div class="col-sm-2 no-padding photobox">--}}
						{{--<div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a--}}
						{{--href="ads-details.html"><img class="thumbnail no-margin" src="images/item/tp/Image00008.jpg"--}}
						{{--alt="img"></a></div>--}}
						{{--</div>--}}
						{{--<!--/.photobox-->--}}
						{{--<div class="col-sm-7 add-desc-box">--}}
						...
						{{--<span class="info-row"> <span data-original-title="Business Ads"--}}
						{{--class="add-type business-ads tooltipHere" data-toggle="tooltip"--}}
						{{--data-placement="right" title="">B </span> <span class="date"><i--}}
						{{--class=" icon-clock"> </i> Today 1:21 pm </span> - <span class="category">Electronics </span>- <span--}}
						{{--class="item-location"><i class="fa fa-map-marker"></i> New York </span> </span></div>--}}
						{{--</div>--}}
						{{--<!--/.add-desc-box-->--}}
						...
						{{--<div class="col-sm-2 no-padding photobox">--}}
						{{--<div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a--}}
						{{--href="ads-details.html"><img class="thumbnail no-margin" src="images/item/tp/Image00014.jpg"--}}
						{{--alt="img"></a></div>--}}
						{{--</div>--}}
						{{--<!--/.photobox-->--}}
						{{--<div class="col-sm-7 add-desc-box">--}}
						...
						{{--<div class="col-sm-2 no-padding photobox">--}}
						{{--<div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a--}}
						{{--href="ads-details.html"><img class="thumbnail no-margin" src="images/item/tp/Image00003.jpg"--}}
						{{--alt="img"></a></div>--}}
						{{--</div>--}}
						{{--<!--/.photobox-->--}}
						{{--<div class="col-sm-7 add-desc-box">--}}
						...
						{{--<div class="col-sm-2 no-padding photobox">--}}
						{{--<div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a--}}
						{{--href="ads-details.html"><img class="thumbnail no-margin" src="images/item/tp/Image00022.jpg"--}}
						{{--alt="img"></a></div>--}}
						{{--</div>--}}
						{{--<!--/.photobox-->--}}
						{{--<div class="col-sm-7 add-desc-box">--}}
					...
					<!--/.adds-wrapper-->
					<div class="text-center">{{ $listings->appends([
...
@section('js2')
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var htmlstr = '';
			htmlstr += 		'<input type="hidden" data-cat-value="Main Cat" id="combo-main-cat" name="mcategory" value="{{ $searchdata['mcategoryid'] }}">';
			htmlstr += 		'<input type="hidden" data-cat-sub-value="Sub cat" id="combo-sub-cat" name="category" value="{{ $searchdata['categoryid'] }}">';
