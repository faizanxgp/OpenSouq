            ...
            <div class="panel-group" id="accordion">
              <div class="panel panel-default">
                ...
                <div id="collapseB1" class="panel-collapse collapse in">
                  <div class="panel-body">
						...
						{{ Form::open(['method' => 'post', 'route' => 'update-account', 'files' => true, 'class' => 'form-horizontal']) }}
                      ...
                      <div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="Phone">Add profile photo of JPG/JPEG type of 300px wide & 300px tall.</label>

							<div class="col-sm-9">
								<input class="form-control" name="photos" type="file"><br />
								@if($user->photo != "")
									<img alt="user" src="{{ URL::to('uploads/users/' . $user->photo) }}" class="userImg2">@endif
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label" for="Phone">Show the phone number on the published ads.</label>

							<div class="col-sm-9">
								<input type="checkbox" name="phone_show" value="1" @if($user->phone_show) checked=""@endif >
							</div>
						</div>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseB2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{{ route('update-password') }}">
