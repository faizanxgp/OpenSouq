                ...
                @foreach($listings as $ad)
                  <tr>
                    ...
                    <td class="add-img-td" style="width:14%">
                      <?php if(isset($ad->photo->first()->photo)) { $p='uploads/ads/' . $ad->photo->first()->photo; } else { $p= 'src/images/product-thumb-default.jpg'; } ?>
                    ...
                    <td class="ads-details-td" style="width:58%">
                      <div>
                        ...
                        <p><strong>Visitors </strong>: {{ $ad->views }} <strong>Located
                            In:</strong> {{ $ad->city->city }}
                        </p>
                      </div>
                    </td>
                    ...
                    <td class="action-td" style="width:10%">
                      <div>
                        ...
                        <p><a class="btn btn-danger btn-xs" href="{{ route('favorite-delete', $ad->id) }}" onclick="return confirm('Are you sure?');" > <i class=" fa fa-trash"></i> Delete
                          </a></p>
                      </div>
                    </td>
                  </tr>
